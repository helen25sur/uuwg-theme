...
$posts_per_page  = $is_all_projects ? -1 : 3;

$allowed_filters = ['active-projects', 'past-projects'];
    ...
    <div class="uuwg-our-projects__header">
      ...
      <?php if ($is_all_projects) : ?>
        <details id="uuwg-project-filter" class="uuwg-our-projects__filters js-projects-filters">
          <?php
          $filter_labels = [
            'all'               => __('All projects', 'uuwg'),
            'active-projects' => __('Active projects', 'uuwg'),
            'past-projects'     => __('Past projects', 'uuwg'),
          ];
          ?>
          <summary class="uuwg-projects-filter__current" aria-label="Projects filter">
            <?php echo esc_html($filter_labels[$filter] ?? ''); ?>
          </summary>
          <ul class="uuwg-projects-filter__list">
            ...
            <li class="uuwg-projects-filter__item <?php echo $filter === 'active-projects' ? "is-active" : ''; ?>"
              data-filter="active-projects">
              <a
                href="<?php echo esc_url(add_query_arg('project_category', 'active-projects', $projects_archive_url)); ?>">
                <?php esc_html_e('Active projects', 'uuwg'); ?>
              </a>
            </li>
